...
class PointNetSetAbstraction(nn.Module):
    ...
    def forward(self, xyz, points):
        if self.group_all:
            ...
            new_xyz, new_points, _, fps_inds = sample_and_group(self.npoint, self.radius, self.nsample, xyz, points, returnfps=True, knn=self.knn)
        ...
        return new_xyz, new_points, fps_inds
