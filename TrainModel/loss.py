...
from loss_utils import GRASP_MAX_WIDTH, GRASP_MAX_TOLERANCE, THRESH_GOOD, THRESH_BAD,transform_point_cloud, generate_grasp_views,batch_viewpoint_params_to_matrix, huber_loss, FocalLoss_Ori , BinaryFocalLoss


scale_distribution_prior = np.load("ScaleDistribution/objects_scales.npy", allow_pickle=True).item()
...
def compute_weighted_grasp_loss(end_points, weight_mask):
    ...
    # 2. inplane rotation classification loss
